...
const Contact = () =>{
    return(
        <div id='contact' className='container mx-auto flex flex-col items-center'> 
            ...
            <div className='flex flex-col items-center md:container md:mx-auto bg-gray-900 rounded-xl pr-9 py-10  md:grid md:items-start md:grid-flow-col md:grid-cols-2 lg:grid-cols-3  xl:bg-green-500 2xl:bg-orange-500'>
                ...
                <div className=' lg:col-span-2 '>
                    <form action="" className='flex flex-col space-y-16 w-60 text-gray-300 text-sm md:space-y-18 md:w-auto'>
